...
void process_next_command() {
  ...
  switch (command_code) {
    ...
    case 'M': switch (codenum) {
      ...
      case 43: //M43 ANFRO COMMAND PART HAS BEEN PICKED AND READY FOR CAMERA ROUTINE
	    gcode_M400();
		SERIAL_PROTOCOLPGM("PART PICKED\n");
		//delay(500);
		break;
		
	  case 44: //M44 ANFRO COMMAND CAMERA LOAD ROUTINE DONE
	    gcode_M400();
		SERIAL_PROTOCOLPGM("CAMERA LOAD DONE\n");
		//delay(500);
		break;
		
	  case 45: //M45 ANFRO COMMAND LASER HAS FINISHED
	    gcode_M400();
		SERIAL_PROTOCOLPGM("LASER DONE\n");
		//delay(500);
		break;

	  case 46: //M46 ANFRO COMMAND CAMERA UNLOADE ROUTINE FINISHED
	    gcode_M400();
		SERIAL_PROTOCOLPGM("CAMERA UNLOAD DONE\n");
		//delay(500);
		break;		
		
	  case 47: //M45 ANFRO COMMAND ROUTINE HAD FINISHED
	    gcode_M400();
		SERIAL_PROTOCOLPGM("ROUTINE FINISHED\n");
		//delay(500);
		break;
	  ...
	  case 49: //M45 ANFRO COMMAND ROUTINE HAD FINISHED
	    gcode_M400();
		SERIAL_PROTOCOLPGM("ONES DONE\n");
		//delay(500);
		break;

	  case 50: //M45 ANFRO COMMAND ROUTINE HAD FINISHED
	    gcode_M400();
		SERIAL_PROTOCOLPGM("TENS DONE\n");
		//delay(500);
		break;

	  case 51: //M45 ANFRO COMMAND ROUTINE HAD FINISHED
	    gcode_M400();
		SERIAL_PROTOCOLPGM("HUNDREDS DONE\n");
		//delay(500);
		break;		
